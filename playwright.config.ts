...
const e2eEnv = {
  ...
  MYSQL_DATABASE: readE2eDatabaseName(process.env),
...
export default defineConfig({
  ...
  // E2E_EXTERNAL_SERVERS=true: skip Playwright-managed webServers and reuse
  // servers started externally (e.g. via Git Bash). Needed in sandboxes where
  // cmd.exe spawns are blocked. Default behaviour (managed webServers) is unchanged.
  webServer:
