...
const createMockRequest = (body = {}, params = {}, query = {}, user = { userId: 999999 }) =>
  ({
    body,
    params,
    query,
...
describe('moodController', () => {
  ...
  describe('updateMoodHandler', () => {
    ...
    it('should return 404 for non-existent mood', async () => {
      const req = createMockRequest({ moodType: '快乐', intensity: 8 }, { id: '99999999' })
      const res = createMockResponse()
  ...
  describe('deleteMoodHandler', () => {
    ...
    it("should return 403 when deleting other user's mood", async () => {
      const req = createMockRequest({}, { id: moodId.toString() }, {}, { userId: 888888 })
      const res = createMockResponse()
