...
export const HIGH_RISK_ESCALATION = {
  prefix: '⚠️ 检测到高风险内容\n\n',
  suffix: `\n\n如果你正处于紧急危险中，请立即联系身边可信任的人或学校支持，并拨打当地紧急服务 110/120；也可联系${formatCrisisSupport()}。AI 和心理援助热线不能替代紧急救援。`,
  fixedResponse: {
    summary: '检测到高风险内容，建议立即寻求专业帮助。',
    possibleCauses: '无法通过 AI 分析高风险情况，请联系专业机构。',
    todayActions: [
      '立即联系信任的人或学校支持，告诉他们你的感受',
      '如有立即危险，拨打当地紧急服务 110/120',
      `联系${formatCrisisSupport()}`,
    ],
    whenToSeekHelp: '请立即寻求身边人员和当地紧急服务的帮助；AI 和心理援助热线不能替代紧急救援。',
  },
}
