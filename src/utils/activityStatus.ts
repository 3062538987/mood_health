import type { Activity, ActivityStatus, ActivityStatusConfig } from '@/types/activity'
 ...
 * @returns 活动状态
 */
export const calculateActivityStatus = (activity: Activity): ActivityStatus => {
 ...
 * @returns 状态配置对象
 */
export const getActivityStatusConfig = (status: ActivityStatus): ActivityStatusConfig => {
